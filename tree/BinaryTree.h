...
Status InOrderTraverse(BiTNode T, Status visit(char data));	//中序遍历
Status PostOrderTraverse(BiTNode T, Status visit(char data));	//后序遍历
Status LevelOrderTraverse(BiTNode T, Status visit(char data));	//层序遍历
/*
